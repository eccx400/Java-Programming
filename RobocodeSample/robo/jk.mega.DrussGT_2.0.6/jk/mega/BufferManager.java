   ...
   import java.util.*;
    ...
    //Featuring "Slice retrieval indexes"
      ...
      static final float[] accelSlicesFine = {-2.001f, -1.999f, 0.999f, 1.001f};
      ...
      static final float[] dl10SlicesRough = {25f ,50f ,75f};
      static final float[] dl10Slices = {10f ,20f ,35f ,50f ,65f ,80};
      static final float[] dl10SlicesFine = {8f, 20f ,30f, 40f, 50f, 60f ,70f ,80f ,90f};
      ...
      static final float[] wallSlices = {0.25f , 0.5f , 0.75f};
       ...
       public static ArrayList getFlattenerBuffers(){
         ...
         float[][][] flatTickSets = new float[][][] { 
               {velSlices, advVelSlicesRough, bftSlicesFine, tsdcSlicesFine, empty, tsvcSlices, empty, empty, wallSlicesRough},
               {velSlices, advVelSlices, empty, empty, empty, tsvcSlicesRough, dl10Slices, wallSlices, empty},
               {velSlices, advVelSlicesRough, bftSlicesFine, empty, empty, tsvcSlicesFine, empty, wallSlices, empty},
               {velSlicesFine, advVelSlicesRough, empty, empty, empty, empty, empty, empty, wallSlicesRough},
               {empty, advVelSlicesRough, bftSlicesRough, tsdcSlicesRough, accelSlices, empty, dl10Slices, empty, empty},
               {velSlices, empty, empty, empty, accelSlices, tsvcSlices, dl10SlicesRough, wallSlicesRough, empty},
               {velSlicesFine, advVelSlices, bftSlicesFine, empty, empty, tsvcSlicesFine, empty, wallSlices, empty},
               {empty, empty, bftSlices, empty, accelSlices, tsvcSlicesFine, empty, wallSlices, wallSlicesRough},
               {velSlices, advVelSlicesFine, bftSlicesFine, tsdcSlices, empty, empty, dl10SlicesFine, empty, empty},
               {velSlicesRough, empty, empty, tsdcSlicesFine, empty, tsvcSlices, empty, empty, empty},
               {velSlicesFine, advVelSlices, bftSlicesRough, tsdcSlicesFine, empty, empty, dl10SlicesFine, wallSlices, empty},
               {velSlicesRough, advVelSlicesRough, empty, empty, empty, tsvcSlicesRough, dl10Slices, empty, empty},
               {empty, advVelSlicesRough, bftSlices, empty, accelSlices, tsvcSlicesFine, dl10SlicesRough, wallSlicesRough, empty},
               {velSlicesFine, empty, empty, tsdcSlicesFine, accelSlices, tsvcSlices, empty, empty, empty},
               {velSlices, advVelSlices, bftSlicesFine, empty, accelSlices, empty, dl10Slices, empty, empty}
               };
